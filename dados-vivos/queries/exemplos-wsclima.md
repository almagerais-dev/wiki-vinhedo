...
Substituir `$WSCLIMA_API_TOKEN` e `{station_id}` pelos valores reais (ver
...
```bash
curl -sS -H "Authorization: Bearer $WSCLIMA_API_TOKEN" \
  "https://api.wsclima.com.br/integrations/stations/{station_id}/data/current"
```
...
```bash
curl -sS -H "Authorization: Bearer $WSCLIMA_API_TOKEN" \
  "https://api.wsclima.com.br/integrations/stations/{station_id}/data/historical/20260701/20260707"
```
...
```bash
curl -sS -H "Authorization: Bearer $WSCLIMA_API_TOKEN" \
  "https://api.wsclima.com.br/integrations/stations/{station_id}/data/historical/20260501/20260630"
```
