...
- **Local:** [[macaia]]
- **Identificação na fonte:** parte `1` do MultiPolygon `Plantio Vivert` na coleção de
  2026-08-29, normalizada como `setor-01`. A confirmação dos doze setores registra que essa
  parte corresponde ao `Talhao 1` do mapa anterior.
- **Área:** 0,4657 ha, calculada sobre o polígono em elipsoide WGS84 (geodésica);
