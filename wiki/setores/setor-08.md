...
- **Local:** [[macaia]]
- **Identificação na fonte:** parte `8` do MultiPolygon `Plantio Vivert` na coleção de
  2026-08-29, normalizada como `setor-08`. A confirmação dos doze setores registra que essa
  parte corresponde ao `Talhao 8` do mapa anterior.
- **Área:** 0,2704 ha, calculada sobre o polígono em elipsoide WGS84 (geodésica);
