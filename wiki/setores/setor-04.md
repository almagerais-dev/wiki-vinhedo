...
- **Local:** [[macaia]]
- **Identificação na fonte:** parte `6` do MultiPolygon `Plantio Vivert`, ligada a
  `setor-04` pela imagem rotulada de 2026-08-29. As partes não carregam atributo e a ordem
  delas no arquivo **não** acompanha a numeração dos setores.
- **Área:** 1,0730 ha, geodésica WGS84 calculada sobre a parte `6`; a coleção de 2026-08-29
  não traz `area_ha`.
...
- **Plantas:** 4.038 (mapa de plantio de 2026-08-29).
- **Produção anual esperada:** 5.653,2 kg (valor de planejamento da fonte; não é colheita observada).
...
|---|---|---:|---|---|---|---:|---:|
| 1 a 38 | [[sauvignon-blanc]] | 4.038 | 2021 | 174 | 1103P | 1,4 | 5.653,2 |
