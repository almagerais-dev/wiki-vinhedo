...
- **Local:** [[macaia]]
- **Identificação na fonte:** `Talhao 3` na confirmação de 2026-08-25, normalizado como `setor-03`.
  Na coleção de 2026-08-29 corresponde à parte `3` do MultiPolygon `Plantio Vivert`.
- **Área:** 1,2055 ha, calculada sobre o polígono em elipsoide WGS84 (geodésica);
