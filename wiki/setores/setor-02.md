...
- **Local:** [[macaia]]
- **Identificação na fonte:** `Talhao 2` na confirmação de 2026-08-25, normalizado como `setor-02`.
  Na coleção de 2026-08-29 corresponde à parte `2` do MultiPolygon `Plantio Vivert`.
- **Área:** 1,2883 ha, calculada sobre o polígono em elipsoide WGS84 (geodésica);
