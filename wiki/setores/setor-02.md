...
- **Local:** [[macaia]]
- **Identificação na fonte:** `Talhao 2` na coleção de 2026-08-25, normalizado como `setor-02`.
  Na coleção de 2026-08-29 corresponde à parte `2` do MultiPolygon `Plantio Vivert`.
- **Área:** 1,2918 ha (propriedade da fonte 2026-08-25; a geometria vigente não traz área).
